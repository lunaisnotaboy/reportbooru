module Reports
  def generate_all
    [AddRequestTags, Approvers, ArtistCommentaries, Artists, BulkUpdateRequests, Comments, ContributorUploads, DownVotes, ForumPosts, ForumTopics, InactiveApprovers, MemberUploads, Pools, PostAppeals, PostChanges, PostFlags, PostReplacements, Notes, TagAliases, TagImplications, Taggers, TagVandalism, TranslatorTags, WikiPages].each do |model|
    	begin
	      model.new.generate
	    rescue => e
